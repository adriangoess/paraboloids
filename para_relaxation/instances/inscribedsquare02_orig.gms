...
e2.. sin(x2)*cos(x2 - x2*x2) - x6 =E= 0;

e3.. sin(x2)*x2 - x7 =E= 0;

e4.. sin(x3)*cos(x3 - x3*x3) - x6 - x8 =E= 0;

e5.. sin(x3)*x3 - x7 - x9 =E= 0;

e6.. sin(x4)*cos(x4 - x4*x4) - x6 + x9 =E= 0;

e7.. sin(x4)*x4 - x7 - x8 =E= 0;

e8.. sin(x5)*cos(x5 - x5*x5) - x6 - x8 + x9 =E= 0;
